...
- `variable`: variable containing occupational codes. In our case, they are named *OCC2010* in CPS-USA database, and *P3* in ENOE - Mexico database.  
...
Based on this reclassification to ISCO-08 we can now  compare the distribution of skill levels of occupations among both countries ^[Note that for simplicity we are not using here survey weights. A more accurate analysis should include them].

 - 47% of U.S. occupations are classified at the high-skill level.   
