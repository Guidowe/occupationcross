...
Once the dataframe is loaded, we can use  ```reclassify_to_isco08``` in order to reclassify the variable *"OCC"* that contains the occupation clasification whit the *"Census2010"* system. We also set ```add_major_groups``` as TRUE.
