...
#' @param summary If TRUE provides other dataframe counting how many cases where asigned for each occupation code to each skill level.
...
#' @examples
#'
#' base_skill <- skill_level(toy_base_ipums_cps_2018, OCC, classif_origin="Census2010")
#' load("data/toy_base_uruguay.rda")
#' base_skill <- skill_level(toy_base_uruguay, f71_2, classif_origin="ISCO08")
#'
#'
#'


skill_level <- function(base, variable, classif_origin, summary = FALSE){
